...
env -u LD_LIBRARY_PATH python3 tools/export_weights.py > build_export.log 2>&1
env -u LD_LIBRARY_PATH python3 tools/pipeline.py --quant w4a4 --seed 0 --out build/w4a4_seed0.png > build_w4a4.log 2>&1
