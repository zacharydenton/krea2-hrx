...
[Apache-2.0](https://huggingface.co/Qwen/Qwen3-VL-4B-Instruct/blob/main/README.md).
A copy of that license is included in [LICENSE-APACHE-2.0](LICENSE-APACHE-2.0).
The project's MIT license does not replace this asset's upstream license.
