...
// query32 regresses eight-step image quality despite passing block cosine checks.
// Keep the original fp16 kernel at every sequence length; query32 is benchmark-only.
inline int fp16_query_tiles(int) { return 1; }
